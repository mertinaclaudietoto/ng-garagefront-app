...
@Component({
  ...
  imports: [RouterModule, FeatureswidgetComponent, FooterwidgetComponent, HerowidgetComponent, HighlightswidgetComponent, RippleModule, StyleClassModule, ButtonModule, DividerModule],
